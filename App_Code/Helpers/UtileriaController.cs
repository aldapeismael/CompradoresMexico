...
public class UtileriaController : ApiController
{
    ...
    //public bool SubirArchivo(string StrRutaArchivo)
    //{
    //    var BArchivoCorrecto = false;
    //    DateTime DtFechaActual = DateTime.Now;
    //    String StrNombreArchivo = StrRutaArchivo + ObjArchivo.FileName + "_" + DtFechaActual.Day + DtFechaActual.Month + DtFechaActual.Year + "_" + DtFechaActual.Hour + DtFechaActual.Hour + DtFechaActual.Hour;
    //    try
    //    {
    //        ObjArchivo.SaveAs(StrNombreArchivo);
    //        if (File.Exists(StrNombreArchivo))
    //        {
    //            BArchivoCorrecto = true;
    //        }
    //    }
    //    catch (Exception ex)
    //    {
    ...
    //    //var ObjArchivo = HttpContext.Current.Request.Files["Archivo"];
    //    //var LstArrayStrDetalle = new List<string[]>();
    //    //try
    //    //{
    //    //    StreamReader CVSStreamReader = new StreamReader(ObjArchivo.InputStream);
    //    //    while (!CVSStreamReader.EndOfStream)
    //    //    {
    //    //        var StrFila = CVSStreamReader.ReadLine();
    //    //        LstArrayStrDetalle.Add(StrFila.Split(StrSeparador));
    //    //    }
    //    //    if (LstArrayStrDetalle.Count() > 0)
    //    //    {
    //    //        ObjArchivo.SaveAs(StrRutaArchivo + ObjArchivo.FileName);
    //    //    }
    //    //}
    //    //catch (Exception e)
    //    //{
    ...
    //    //string Destpath = @"C:\Users\alianza\Downloads\prueba.json";
    ...
    //    //sw.Write(json);
    //    //sw.Close();
    //    //var algo = csv.Select(x => new Acceso()
    //    //{
    //    //    IntBRobot = int.Parse(x[0].ToString())
    //    //}).ToList();
